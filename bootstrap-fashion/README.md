...
## Overview
Bootstrap Fashion is a modern & flexible responsive HTML Bootstrap 5 template with customizable card listings on the category page and an excellent product display on the individual product page. It's the perfect starting point for any fashion retail website, and the template's clean and minimal design means it's easy to modify and painless to integrate with your custom Ecommerce application. And above all, it's free!

<strong><a href="YOUR_LIVE_DEMO_LINK_HERE">View Demo</a> | <a href="https://github.com/bayzed123/websites-tamplate/archive/refs/heads/main.zip">Download ZIP</a></strong>

![Bootstrap 5 Responsive HTML Fashion Store Template](https://pixelrocket-public-assets.s3.eu-west-2.amazonaws.com/github-assets/oldskool-html/homepage-medium.jpg "Bootstrap Fashion | Responsive Bootstrap 5 Ecommerce Template")
...
## Quick Start
- [Download the latest release](https://github.com/bayzed123/websites-tamplate/archive/refs/heads/main.zip) OR clone the repo: `git clone https://github.com/bayzed123/websites-tamplate.git`
- Install Node.js if you don't already have it on your system.
- Open the project root in your command line.
- Navigate to the template directory: `cd bootstrap-fashion`
...
## Demo Link
[Demo URL](YOUR_LIVE_DEMO_LINK_HERE)
...
ð dist - Generated version of the template. Go here if you do not want to work with the template source code. But be warned: if you customise anything in this folder directly, and then later recompile the template using webpack, unless you move the dist folder out of the template, your changes will be overridden.

ð node_modules - Directory where NPM installs dependancies. You will not see this folder until you complete the template installation. You do not need to create this folder.

ð src - Template source code. Go here to customise your template.

ð src/assets - Template assets such as CSS, JS, Images etc.

ð src/data - Template JSON Data files. We use these JSON files to make your job easier to insert content into the template. 

ð src/html - Template pages. Go here to edit existing pages or add new pages.

ð src/partials - Handlebars partial templates. 
